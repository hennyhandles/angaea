...
50.times do
  ...
  User.all.each { |user| user.activities.create!(picture: Faker::LoremPixel.image("50x60"), activity_name: Faker::GameOfThrones.quote, content: content, category: types[rand(3)], cost: rand(500), city: Faker::Address.city, state: Faker::Address.state, addressLN1: Faker::Address.street_address, zip: Faker::Address.zip) }
end
