class ActivitiesController < ApplicationController
 ...
 def destroy
  ...
  private
  def activity_params
    params.require(:activity).permit(:capacity, :contact_email, :contact_number, :activity_name, :content, :category, :additional_info, :cost, :start_date, :end_date, :picture, :addressLN1, :addressLN2, :city, :state, :zip)
  end
end
